    ...
    <div className="flex flex-col h-full bg-[#F8FAFC]  overflow-y-auto no-scrollbar pb-10 transition-colors duration-300">
      ...
      <main className="px-6 space-y-6 pt-2">
          ...
          {languages.map((lang) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center justify-between p-7 rounded-[2.5rem] bg-white  shadow-sm border transition-all duration-300 active:scale-[0.98] ${isSelected ? 'border-indigo-500/30 ring-1 ring-indigo-500/10' : 'border-gray-100  opacity-70'
                  }`}
              >
        ...
        <div className="pt-12 px-8">
          <p className="text-[10px] text-gray-400  font-black uppercase tracking-[0.25em] text-center leading-relaxed opacity-60">
            {language === 'es'
