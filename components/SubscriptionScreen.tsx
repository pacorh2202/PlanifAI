...
export const SubscriptionScreen: React.FC<SubscriptionScreenProps> = ({ onBack }) => {
    ...
    return (
        <div className="flex flex-col h-full bg-[#F8FAFC] dark:bg-black overflow-y-auto overflow-x-hidden no-scrollbar pb-32 transition-colors duration-500" style={{ touchAction: 'pan-y' }}>
            {/* Elegant Header */}
            <header className="px-6 pb-4 flex items-center justify-between sticky top-0 z-30 bg-[#F8FAFC]/90 dark:bg-black/90 backdrop-blur-xl border-b border-gray-100 dark:border-gray-900" style={{ paddingTop: 'calc(env(safe-area-inset-top) + 48px)' }}>
